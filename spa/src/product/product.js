...
class Product extends Component {
  ...
  getProduct(accessToken) {
    ...
    axios
      .get(Constants.PRODUCT_SVC_URL + this.props.productId)
      .then((response) => {
        ...
        product.imageUrl =
          Constants.PRODUCT_IMAGE_BASE_URL + postfix_char + ".jpeg";
      ...
      .then(() => {
        axios.defaults.headers.common["Authorization"] =
          "Bearer " + accessToken;
        axios
          .get(Constants.CART_SVC_URL + this.getCartId())
          .then((response) => {
            console.log(response.data);
  ...
  addToCart(cartId, productId, event) {
    ...
    axios
      .post(Constants.CART_SVC_URL, params, config)
      .then((response) => {
        console.log(response.data);
        console.log("Product request STATUS = " + response.status);
        this.setState({ remBtnVisible: "visible" });
              ...
              <div className="col-xs-12 col-md-7">
                ...
                <div className="form-horizontal">
                  ...
                  <div className="form-group">
                    ...
                    <div>
                      <button
                        onClick={this.addToCart.bind(this, cartId, product.id)}
                      ...
                      <button
                        ...
                        style={{
                          visibility: this.state.remBtnVisible,
                          margin: "1em 0",
                        }}
                      >
                        Remove
...
function SampleText(props) {
  return (
    <p>
      {props.productName}, internationally acclaimed textbook provides a
      comprehensive introduction to the modern study of computer algorithms. It
      covers a broad range of algorithms in depth, yet makes their design and
      analysis accessible to all levels of readers. Each chapter is relatively
      self-contained and presents an algorithm, a design technique, an
      application area, or a related topic. The algorithms are described and
      designed in a manner to be readable by anyone who has done a little
